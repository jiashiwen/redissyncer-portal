...
func GetMultipleValuesWithPaginationDemo(ctx context.Context, kv clientv3.KV) {
	...
	logger.Logger().Sugar().Info("*** GetMultipleValuesWithPaginationDemo()")
	// Delete all keys
	...
	logger.Logger().Sugar().Info("Total count: ", total, "Pages: ", pages, "Reaminder: ", remainder)
